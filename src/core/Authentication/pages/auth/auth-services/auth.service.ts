...
apiUrl=environment.apiUrl;
  ...
  SignIn(body:user): Observable<any> {
    return this.http.post(`${this.apiUrl}v2/account/addorget`, body,this.getHeaders())
  }
  /*========================================================================================*/

  SignIn2(body:user):  Observable<any> {
    return this.http.post(`${this.apiUrl}v2/account/login`, body,this.getHeaders())
  }
  /*========================================================================================*/
  SignUp(body:user): Observable<any> {
    return this.http.post(`${this.apiUrl}v2/Account/Create`, body,this.getHeaders())
  }

  /*========================================================================================*/
  VerifyPhoneNumber(body:userVerified): Observable<any> {
    return this.http.post(`${this.apiUrl}v2/account/VerifyPhoneNumber`, body,this.getHeaders())
  }

  /*========================================================================================*/
  ResendVerifyCode(body:user ): Observable<any> {
    return this.http.post(`${this.apiUrl}v2/Account/ResendVerifyCode`, body,this.getHeaders())
  }
